...
public class XpathDemo {
    public static void main(String[] args) {
        ...
        userName.sendKeys("tester");// better to use like that to use it again see below
        //find the password field
        driver.findElement(By.xpath("//input[@type='password']")).sendKeys("test");

        //clear username text box using method clear()
        userName.clear();

        //to get the text username which is beside the username box
